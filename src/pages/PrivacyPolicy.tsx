      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-lg">
            ...
            <p>At IntiMore ("we", "us", or "our"), we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website or use our services.</p>
            ...
            <p>If you have any questions about this Privacy Policy, please contact us at privacy@intimore.com.</p>
          </div>
        </div>
      </main>
      <Footer />
