      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-lg">
            ...
            <p>Welcome to IntiMore ("we", "us", or "our"). By accessing or using our website, products, or services, you agree to be bound by these Terms of Service ("Terms").</p>
            ...
            <p>In no event shall IntiMore, its affiliates, or their respective officers, directors, employees, or agents be liable for any indirect, incidental, special, punitive, or consequential damages arising out of or related to your use of our services.</p>
            ...
            <p>These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which IntiMore is registered, without regard to its conflict of law provisions.</p>
            
            <h2 className="text-xl font-semibold mt-6 mb-3">10. Contact Information</h2>
            <p>If you have any questions about these Terms, please contact us at support@intimore.com.</p>
          </div>
        </div>
      </main>
      <Footer />
